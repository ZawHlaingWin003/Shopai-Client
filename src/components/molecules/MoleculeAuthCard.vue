<template>
    <div
        class="border rounded shadow lg:mx-auto lg:w-1/2 bg-white dark:bg-black dark:border-black dark:divide-soft-dark px-4 md:px-10 pt-4 pb-8"
    >
        <div class="card-header text-center space-y-8">
            <div class="space-y-4">
                <atom-logo class="mx-auto" />
                <h2 class="text-xl lg:text-2xl font-bold text-primary-500">
                    <slot name="header" />
                </h2>
            </div>
            <div class="space-y-8">
                <div
                    class="social-buttons space-y-4 md:space-y-0 md:flex md:gap-4 lg:gap-8"
                >
                    <button
                        class="border p-2 md:px-0 rounded-md hover:bg-light w-full flex items-center justify-center gap-4 dark:hover:bg-soft-dark dark:border-soft-dark"
                    >
                        <svg
                            class="w-4 h-4"
                            viewBox="0 0 21 20"
        ...
        <div
            class="card-footer pt-8 border-t-2 border-opacity-30 border-t-soft-dark"
        >
